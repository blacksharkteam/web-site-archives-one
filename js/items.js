...
$(document).ready(function () {
  ...
  $('#web-site-archives-one').dblclick(function () {
    window.open('https://blacksharkteam.github.io/web-site-archives-one/');
  });


  $('#web-site-project-one').dblclick(function () {
    window.open('https://blacksharkteam.github.io/web-site-Black-Shark-one/');
  });


  $('#birthday-me').dblclick(function () {
    window.open('https://ah03250.blogspot.com/');
  });


  $('#web-site-project-two').dblclick(function () {
    window.open('https://blacksharkteam.github.io/web-site-Black-Shark-two/');
  });


  $('#wiki-ah').dblclick(function () {
    window.open('https://wikiah.blogspot.com/');
  });
